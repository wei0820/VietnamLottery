...
public final class LoadingViewBinding implements ViewBinding {
  ...
  private LoadingViewBinding(@NonNull RelativeLayout rootView, @NonNull RelativeLayout loading,
  ...
  public static LoadingViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LoadingViewBinding((RelativeLayout) rootView, loading, progressText);
    }
