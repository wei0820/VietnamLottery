...
public final class ActivityUserLoginBinding implements ViewBinding {
  ...
  private ActivityUserLoginBinding(@NonNull ConstraintLayout rootView, @NonNull CheckBox checkbox,
      @NonNull EditText edt, @NonNull EditText edt2, @NonNull EditText edt3,
      @NonNull Button loginbtn, @NonNull Button qrlogin, @NonNull TextView text,
  ...
  public static ActivityUserLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.qrlogin;
      Button qrlogin = rootView.findViewById(id);
      if (qrlogin == null) {
        break missingId;
      }
      ...
      return new ActivityUserLoginBinding((ConstraintLayout) rootView, checkbox, edt, edt2, edt3,
          loginbtn, qrlogin, text, text2, text3);
    }
