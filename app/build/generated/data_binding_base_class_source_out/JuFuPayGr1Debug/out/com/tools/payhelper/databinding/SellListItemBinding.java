...
public final class SellListItemBinding implements ViewBinding {
  @NonNull
  ...
  private SellListItemBinding(@NonNull LinearLayout rootView, @NonNull TextView amount,
      ...
      @NonNull Button sureButton, @NonNull TextView time, @NonNull TextView username) {
  ...
  @NonNull
  public static SellListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SellListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.sell_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SellListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SellListItemBinding((LinearLayout) rootView, amount, bankname, cancelButton,
          cardno, layout, orderno, payname, sureButton, time, username);
    }
